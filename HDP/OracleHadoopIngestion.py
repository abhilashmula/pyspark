...
sc_conf = SparkConf()
sc_conf.setAppName("oracle_data_import")
...
df = sqlctx.read.format("jdbc").options(driver="oracle.jdbc.driver.OracleDriver", url="jdbc:oracle:thin:@192.168.1.142:1521/orcl", dbtable="orders",user="c##_demo01", password="infa").load()
